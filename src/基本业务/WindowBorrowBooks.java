...
public class WindowBorrowBooks extends JFrame implements ActionListener {
	JFrame frame;
	...
	void init() {
		...
		labelThree = new JLabel("图书卡号:");
		labelFour = new JLabel("借阅者名：");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(text1.length()!=0 && text2.length()!=0 && text3.length()!=0 && text4.length()!=0) {
			JOptionPane.showMessageDialog(this, "借阅成功", "提示对话框", JOptionPane.WARNING_MESSAGE);
		}
		else {
