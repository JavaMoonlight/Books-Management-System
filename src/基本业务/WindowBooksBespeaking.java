...
public class WindowBooksBespeaking extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(text1.length()!=0 && text2.length()!=0 && text3.length()!=0) {
			JOptionPane.showMessageDialog(this, "预约成功", "提示对话框", JOptionPane.WARNING_MESSAGE);
			this.textOne.setText("");
			this.textTwo.setText("");
			this.textThree.setText("");
		}
		else {
			JOptionPane.showMessageDialog(this, "预约失败，请重新输入", "警告对话框", JOptionPane.WARNING_MESSAGE);
		}
	}
}
